...
class Flight {
    ...
    // method Override tostring pada commersial flight 
...
class CommercialFlight extends Flight {
    ...
    // method override tostring pada private flight
    @Override
    public String toString() {
...
class PrivateFlight extends Flight {
    ...
    // method override tostring pada flight management
    @Override
    public String toString() {
        return super.toString() + "\nTipe: Pribadi\nPemilik: " + owner;
    }
...
public class FlightManagement {
    ...
    // Method Overloading tanpa index pada display flight info
    ...
    // Method Overloading menggunakan index pada display flight info
