...
class Flight {
    // Menggunakan private untuk enkapsulasi (Hanya bisa diakses dalam kelas itu sendiri.)
    ...
    //Menggunakan Public untuk enkapsulasi (Bisa diakses dari mana saja.)
    ...
    // Getter dan Setter pada departureTime digunakan untuk mendapatkan dan memperbarui nilai departureTime
    ...
    // Getter dan Setter digunakan untuk mendapatkan dan memperbarui nilai airlineName
...
public class FlightManagement {
    ...
    static void updateFlight() {
        ...
        if (index >= 0 && index < flights.size()) {
            ...
            flights.get(index).setDepartureTime(scanner.nextLine());
            System.out.print("Masukkan Nama Pesawat Baru: ");
            flights.get(index).setAirlineName(scanner.nextLine());
